export const BUILDING_CATEGORIES = {
  ...
  NATURE: {
    ...
    items: [
      ...
      { id: 'pond', name: 'Small Pond', color: '#60a5fa', type: 'water', emoji: '💧' },
      { id: 'lake', name: 'Deep Lake', color: '#2563eb', type: 'water', emoji: '🌊' },
      { id: 'river', name: 'Wide River', color: '#1d4ed8', type: 'water', emoji: '🛶' }
    ]
  },
  INFRASTRUCTURE: {
    id: 'infra',
